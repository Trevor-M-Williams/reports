  ...
  return (
    <div>
      <div
        ...
        className="text-blue-700 text-4xl cursor-pointer"
      >
        Upload
      </div>
      <FileInput open={uploadOpen} setOpen={setUploadOpen} />
    </div>
    // <div className="absolute inset-x-0 p-2 pt-12 overflow-hidden">
    ...
    //                 className="absolute top-2 bottom-2 right-4 flex items-center bg-white shadow px-2 rounded text-xs cursor-pointer hidden hover:bg-gray-100"
    //               >
    //                 <svg
    //                   viewBox="0 0 16 16"
    //                   height="14px"
    ...
    //             <td className="border px-4 py-2 w-[5%]">Active</td>
    //           </tr>
    //         ))}
    //     </tbody>
    //   </table>
