...
function DragAndDropFileInput() {
  ...
  function handleRemoveFileClick(fileIndex) {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      >
        <>
          <p className="text-2xl text-[#ccc]">Drag and drop files here</p>
          <input
            type="file"
            className="hidden"
            multiple
          ...
          />
          <button
            className="bg-blue-500 hover:bg-blue-700 text-white font-medium mt-4 py-2 px-4 rounded"
