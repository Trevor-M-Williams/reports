      ...
      <div className="relative flex h-[50vh] w-full max-w-md items-center justify-center rounded-lg bg-white p-10">
        ...
        >
          <div className="w-full">
            ...
            {file && (
              <div
                className={`relative mx-auto flex w-4/5 items-center overflow-hidden rounded-full border px-6 py-1 ${
              ...
              >
                <div
                  ...
                  style={{ width: percent + "%" }}
                ></div>
                <p className="relative select-none text-xl leading-none text-[#333]">
                  {file.name}
                </p>
                {!loading && (
                  <button
